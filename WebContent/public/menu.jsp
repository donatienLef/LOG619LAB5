...
<div id="navigation">
    ...
    <ul class="sansPuce">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <c:choose>
                    <c:when test="${ utilisateur.poste == 'Administrateur affaire' ||  utilisateur.poste == 'Administrateur residentiel'}">
                        <li><a href="<c:url value="/Home"/>" class="boutton_nav">Mon
                            espace</a></li>
                        <li><a href="<c:url value="/Home/ListeUtilisateur"/>" class="boutton_nav">Liste
                            clients</a></li>
                        <li><a href="<c:url value="/ChangePassword"/>" class="boutton_nav">Change Password</a></li>
